...
import { ProtectPayment, ProtectCustomerDashboard, ProtectProviderDashboard, ProtectSession } from './Components/ProtectedRoute/ProtectedRoute'
const App = () => {
  return (
    <Router>
      <Switch>
        ...
        <ProtectSession path='/session/:id' component={Sessions} />
