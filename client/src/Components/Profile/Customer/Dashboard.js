...
const Dashboard = () => {
  ...
  const getAppointmentData = async () => {
    const apiUrl = `https://e-health.work/api/get/customer/appointments/${customer.userId}`
  ...
  const cancelAppointment = async (appointment) => {
    ...
    if (confirmDelete === true) {
      const apiUrl = `https://e-health.work/api/delete/appointment/${appointment.id}`
  ...
  useEffect(() => {
    const submitAppointment = async () => {
      if (dateAndTimeErrors.date === null && dateAndTimeErrors.time === null) {
        ...
        const apiUrl = `https://e-health.work/api/update/appointment${appointmentReschedule}`
